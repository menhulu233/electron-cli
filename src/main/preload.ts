...
const electronAPI = {
  ...
  window: {
    ...
    onMaximized: (callback: () => void) => {
      ipcRenderer.on(IpcChannel.Window.OnMaximized, () => callback());
    },
    onUnmaximized: (callback: () => void) => {
      ipcRenderer.on(IpcChannel.Window.OnUnmaximized, () => callback());
    },
    removeAllWindowListeners: () => {
      ipcRenderer.removeAllListeners(IpcChannel.Window.OnMaximized);
      ipcRenderer.removeAllListeners(IpcChannel.Window.OnUnmaximized);
    },
  },
